 ...
 */
public class JobInPermutationNotFoundException extends Exception {
	/**
	 * The default serial version UID.
	 */
	private static final long serialVersionUID = 3432667915361789649L;

	public JobInPermutationNotFoundException() {
		super();
	}

	public JobInPermutationNotFoundException(String message) {
		super(message);
	}
