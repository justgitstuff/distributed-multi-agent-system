/*
 * $LastChangedRevision: 341 $ $LastChangedBy: edu $ $LastChangedDate:
 ...
 */
public class AgentIndexOutOfBoundsException extends Exception {
	/**
	 * The default serial version UID.
	 */
	private static final long serialVersionUID = 3432667915361789649L;

	public AgentIndexOutOfBoundsException() {
		super();
	}

	public AgentIndexOutOfBoundsException(String message) {
		super(message);
	}
