 ...
 */
package de.hft_stuttgart.sopro.mediator.exceptions;

/**
 * @author Annemarie Meissner
 */
public class GenerateProposalException extends Exception {
	/**
	 * The default serial version UID.
	 */
	private static final long serialVersionUID = 5675047442032548086L;

	public GenerateProposalException() {
		super();
	}

	public GenerateProposalException(String message) {
		super(message);
	}
