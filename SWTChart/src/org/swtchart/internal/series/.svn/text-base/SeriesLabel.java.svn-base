...
/**
 * Changed by Matthias Huber - MatthewHuber@web.de 5.12.2009
 * 
 * A series label.
 */
public class SeriesLabel implements ISeriesLabel {
    ...
    /**
     * @see ISeriesLabel#setLabelText(String)
     */
    ...
    protected void draw(GC gc, int h, int v, double ySeriesValue,
        ...
        // get text
        String text;
        // changed by Matthias Huber - Matthew.Huber@web.de 5.12.2009
        // if defined then use this!!
        if (null != labelText) {
        	text = labelText;
        } else if (isDecimalFormat(format1)) {
