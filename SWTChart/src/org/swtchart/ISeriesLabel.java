/*******************************************************************************
 * Copyright (c) 2008-2009 SWTChart project. All rights reserved. This code is
 * distributed under the terms of the Eclipse Public License v1.0 which is
...
public interface ISeriesLabel {
	...
	/**
	 * Added by Matthias Huber - MatthewHuber@web.de 5.12.2009
	 * 
	 * Sets the label text.
	 * 
	 * @param text
